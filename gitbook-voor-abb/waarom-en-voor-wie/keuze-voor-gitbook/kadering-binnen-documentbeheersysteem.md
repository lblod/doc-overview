...
1. **Binnen het team**\
   Zowel leden van het Digiteam binnen ABB als contracthouders
2. **Naar externen**\
   De community die we willen uitbouwen om bij te dragen aan onze open source software, partners en leveranciers
...
{% embed url="https://binnenland.atlassian.net/browse/GN-252" %}
Link naar voorbeeld
{% endembed %}
